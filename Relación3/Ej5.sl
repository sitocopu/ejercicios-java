// Pedir el día, mes y año de una fecha e indicar si la fecha es correcta. Con meses de 28, 30 y 31 días. CONSIDERANDO años bisiestos.
...
inicio
	...
	sino si (mes == 2) // Si es febrero tendra mas condiciones.

		si(ano % 4 == 0 and (ano % 100 <> 0 or ano % 400 == 0)){ // Si el año es bisiesto
			checkDia = dia >= 1 and dia <=29
